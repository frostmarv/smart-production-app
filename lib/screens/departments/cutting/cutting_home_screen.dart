// lib/screens/departments/cutting/cutting_home_screen.dart
import 'package:flutter/material.dart';

/// Home screen untuk departemen Cutting.
/// Menampilkan daftar sub-process yang dapat diakses.
class CuttingHomeScreen extends StatefulWidget {
  const CuttingHomeScreen({super.key});

  @override
  State<CuttingHomeScreen> createState() => _CuttingHomeScreenState();
}

class _CuttingHomeScreenState extends State<CuttingHomeScreen>
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(
                                Icons.content_cut_rounded, // Icon cutting
                                color: Colors.white,
                                size: 32,
                              ),
                            ),
