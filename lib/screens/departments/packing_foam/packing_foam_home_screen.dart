// lib/screens/departments/packing_foam/packing_foam_home_screen.dart
import 'package:flutter/material.dart';

/// Home screen untuk departemen Packing Foam.
/// Menampilkan daftar sub-process yang dapat diakses.
class PackingFoamHomeScreen extends StatefulWidget {
  const PackingFoamHomeScreen({super.key});

  @override
  State<PackingFoamHomeScreen> createState() => _PackingFoamHomeScreenState();
}

class _PackingFoamHomeScreenState extends State<PackingFoamHomeScreen>
                ...
                decoration: const BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      ...
                      Color(0xFF047857), // Even Darker Green
                    ],
                  ),
                ),
                child: Stack(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(
                                Icons.airline_seat_individual_suite_rounded, // Icon foam
                                color: Colors.white,
                                size: 32,
                              ),
                            ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // --- Menu Items (Urutan Baru & Tanpa Webbing & Summary) ---
