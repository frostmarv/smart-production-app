// lib/screens/departments/sewing/sewing_home_screen.dart
import 'package:flutter/material.dart';

/// Home screen untuk departemen Sewing.
/// Menampilkan daftar sub-process yang dapat diakses.
class SewingHomeScreen extends StatefulWidget {
  const SewingHomeScreen({super.key});

  @override
  State<SewingHomeScreen> createState() => _SewingHomeScreenState();
}

class _SewingHomeScreenState extends State<SewingHomeScreen>
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: const Icon(
                                Icons.design_services_rounded, // FIX: Correct icon for sewing
                                color: Colors.white,
                                size: 32,
                              ),
                            ),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // --- Menu Items (Urutan: Output - Material - Losstime - Quality) ---
